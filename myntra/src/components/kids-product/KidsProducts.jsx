...
const KidsProducts = () => {
  ...
  return (
    <div className='mens-product-body'>
      <div className="breadCrumbs">
        <div>
          <p className="homeColor">Home / Clothing / Kids</p>
        </div>
        <div>
          <p className="itemHeadingColor">
            <b>Kids Clothes</b> <span className="itemColor">- {kidsProducts?.length} items</span>
          </p>
        </div>
      ...
      <div>
        ...
        <div className="rightDiv">
          <div className="singleProductDiv">
            {kidsProducts && kidsProducts.map((pro) => (
              <div key={pro.id} className="singleProductCss" onClick={()=>redirect(pro.id)}>
                <img className='product-image-in-all-product' src={pro.image} alt=""></img>
                <h4 className="text_css_Heading">{pro.name}</h4>
                {/* <p className="text_css">Kurta with Palazzos & Dupatta</p> */}
