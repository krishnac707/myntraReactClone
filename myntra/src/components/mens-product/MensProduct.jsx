  ...
  return (
    <div className='mens-product-body'>
      <div className="breadCrumbs">
        <div>
          <p className="homeColor">Home / Clothing / Mens</p>
        </div>
        <div>
          <p className="itemHeadingColor">
            <b>Mens Clothes</b> <span className="itemColor">- {mensProducts?.length} items</span>
          </p>
        </div>
          ...
          <div className="singleProductDiv">
            {mensProducts && mensProducts.map((pro) => (
              <div key={pro.id} className="singleProductCss" onClick={()=>redirect(pro.id)}>
                ...
                {/* <p class="text_css">Kurta with Palazzos & Dupatta</p> */}
